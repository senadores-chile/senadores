...
const girardi = require('./fixtures').girardi
const socialistas = require('./fixtures').socialistas
const metropolitanos = require('./fixtures').metropolitanos
const circunscripcion3 = require('./fixtures').circunscripcion3
const asistenciaLagos = require('./fixtures').asistenciaLagos
const asistencia88 = require('./fixtures').asistencia88
const eleccionesSobre300M = require('./fixtures').eleccionesSobre300M
const viajesZaldivar = require('./fixtures').viajesZaldivar
